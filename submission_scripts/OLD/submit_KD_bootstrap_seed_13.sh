...
R CMD BATCH --no-save --no-restore "--args seed=$SGE_TASK_ID "  hoffman_Analysis_24Jan2022.R output/output.$JOB_ID.$SGE_TASK_ID
echo R CMD BATCH --no-save --no-restore  hoffman_Analysis_24Jan2022.R output/output.$JOB_ID.$SGE_TASK_ID
